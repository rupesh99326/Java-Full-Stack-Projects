...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.anonymous().and().httpBasic().and().authorizeRequests().antMatchers("/users").permitAll();
		httpSecurity.anonymous().and().httpBasic().and().authorizeRequests().antMatchers("/movies").permitAll()
